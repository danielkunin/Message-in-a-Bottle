...
def get_default_parser(num_of_samples=None):
	...
	parser.add_argument('-batch_size',
	                    '-b', dest="batch_size", default=4096, #changed from 512
	                    type=int, help='The size of the batch')

	parser.add_argument('-learning_rate',
	                    '-l', dest="learning_rate", default=0.0002, #changing from 0.0004
	                    type=float,
	...
	parser.add_argument('-net',
	                    '-n', dest="net_type", default='1', #changed from 1
